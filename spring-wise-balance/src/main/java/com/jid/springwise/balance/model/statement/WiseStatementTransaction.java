...
public class WiseStatementTransaction {
    ...
    private WiseMoney totalFees;

    @JsonProperty("details")
    private WiseStatementTransactionDetails details;

    @JsonProperty("exchangeDetails")
    private WiseStatementExchangeDetails exchangeDetails;

    @JsonProperty("runningBalance")
    private WiseMoney runningBalance;
